<x-app-layout>
    <div class="bg-white p-6 rounded-xl shadow-sm card">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
            <h3 class="text-lg font-semibold text-gray-800">Tambah Item Keluar</h3>
        ...
        <form action="{{ route('dashboard.itemsOut.store') }}" method="POST">
            @csrf
            <div class="space-y-8 max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <x-text-input id="date_out" name="date_out" type="date" value="{{ old('date_out') }}"
                        required />
